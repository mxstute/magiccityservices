...
const services = [
  {
    ...
    accent: PINK,
    packages: [
      { name: "Single Item Pickup", price: 79, desc: "One large item — couch, mattress, appliance" },
      { name: "Partial Load", price: 249, desc: "Up to half a truck — small cleanouts" },
      { name: "Full Truckload", price: 449, desc: "Full truck — garage & estate cleanouts" },
    ],
    quoteOnly: true,
  },
  {
    ...
    accent: BLUE,
    packages: [
      { name: "Driveway / Sidewalk", price: 129, desc: "Standard driveway or sidewalk cleaning" },
      { name: "House Exterior", price: 249, desc: "Full house exterior wash" },
      { name: "Full Property", price: 449, desc: "Driveway + house + patio/deck" },
    ],
    quoteOnly: true,
  },
  {
    ...
    accent: PINK,
    packages: [
      { name: "Essential Wash", price: 89, desc: "Hand wash, vacuum, windows, tire dressing", deposit: 25 },
      { name: "Full Detail", price: 199, desc: "Interior shampoo + clay bar + wax", deposit: 50 },
      { name: "Showroom Elite", price: 399, desc: "Paint correction + ceramic sealant", deposit: 100 },
    ],
    quoteOnly: false,
  },
];
